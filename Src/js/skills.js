...
contentElts.forEach((elt) =>{
  ...
  if (num !== 1){
    ...
    elts[0].addEventListener('click',()=>{
      if (Array.from(contentElts[0].classList).indexOf('d-none') > -1){
        contentElts[0].classList.remove('d-none');
      }
      contentElts.forEach((linkelt) =>{
        if (!(linkelt === contentElts[0])){
          if (!(Array.from(linkelt.classList).indexOf('d-none') > -1)){
            linkelt.classList.add('d-none');
          }
    ...
    elts[1].addEventListener('click',()=>{
      if (Array.from(contentElts[1].classList).indexOf('d-none') > -1){
        contentElts[1].classList.remove('d-none');
      }
      contentElts.forEach((linkelt) =>{
    ...
    elts[2].addEventListener('click',()=>{
      if (Array.from(contentElts[2].classList).indexOf('d-none') > -1){
        contentElts[2].classList.remove('d-none');
      }
      contentElts.forEach((linkelt) =>{
    ...
    elts[3].addEventListener('click',()=>{
      if (Array.from(contentElts[3].classList).indexOf('d-none') > -1){
        contentElts[3].classList.remove('d-none');
      }
      contentElts.forEach((linkelt) =>{
